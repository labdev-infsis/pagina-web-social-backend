...
insert into users (id_user, uuid, name, last_name, email, phone, password, photo_cover_path, photo_profile_path)
    ...
    (110, 'a0818068-4880-4055-987c-087f1b1f6635', 'Sergio', 'Salazar Velasco', '202004185@est.umss.edu', '62954271', '$2a$10$2ohp0csjbBWQkcidcmGeyuaP21iST1m2Ps7yBUa6uoViJ9eUYOlBi', null, 'http://localhost:9090/api/v1/images/users/13035150-f880-4475-808c-26086775ad47' ),
    (111, '9bae1fe0-2c56-4091-883d-15458e051500', 'Emely', 'Fernandez Soliz', '202004185@est.umss.edu', '69577142', '$2a$10$ktfNn.Nj3JNA2ssA7UGXaO4CT5uhdFYnOZeFBYq2udWJR9e0mRm5q', null, 'http://localhost:9090/api/v1/images/users/733b01ba-198e-42db-b9ca-d7ace9a7abad'),
    (112, '844b324d-2f5e-41c9-b726-0149eeb01157', 'Javier', 'Lopez Canedo', '202394182@est.umss.edu', '71852821', '$2a$10$xpF9KbOWM5TOhGN82c4nEu/mKV8cDVhT7VM8oYX2Cco89fYcLa6PK', null, 'http://localhost:9090/api/v1/images/users/06b8fbe5-9d91-422b-bd20-6d89d23e5608'),
    (113, '2e121a51-24b5-4aad-92c2-150997ec4266', 'Leonardo', 'Beltran Ramirez', '202120735@est.umss.edu', '75891148', '$2a$10$CwIf2TJz6fJAEnloArOATuBcJfwjwFVH4HaJ1WP9an7lv1OnLmlQ2', null, 'http://localhost:9090/api/v1/images/users/b5de2b13-4720-41e7-87d2-d31abd590fac'),
    (114, 'c332c4ff-49e8-4e0e-a7f4-d59907d8cda3', 'Valeria', 'Gonzales Vargas', 'svaleria.gonzales.vargas@gmail.com', '78823541', '$2a$10$07duh1qsG5SKBdm7wJJ0G.rc4W7RKDW/RxbFPmKCkkBe6ZQSH5BA2', null, 'http://localhost:9090/api/v1/images/users/5e9f9c0d-4c31-4335-a11e-b9c7f6f8a2b1'),
    (115, '9f32985a-f108-4b19-9bda-cab7c501ae68', 'Jose', U&'Monta\00F1o Laura', '202001823@est.umss.edu', '72566218', '$2a$10$xkGBeXE5U8icGM3W95FMMeZnY/LCPi8YR8m1XzH6z43XzZd6ST3DG', null, 'http://localhost:9090/api/v1/images/users/1bed8052-ba51-41c2-88b5-e39e78dbf420'),
    (116, 'ab6e1a7f-4494-4251-8177-dc5c4fe18740', 'Marcos', 'Illanes Martinez', '201800513@est.umss.edu', '74269527', '$2a$10$LUxonHn2Jh9fw5pTpekNru0fmQPpVbTOMtT1Z1p8VrK8lvzCISARC', null, 'http://localhost:9090/api/v1/images/users/28e3d103-76e8-4b0d-b04c-cf2e8821cf6e'),
    (117, 'f8d1c969-af76-4161-b0d7-9c2dfc47e75c', 'Adriana', 'Boza Ruiz', '201904940@est.umss.edu', '70551293', '$2a$10$0ZhhXkuBeYFGM8nOm92keuzBczN5xCchSjjyu/5DSSB.r0LhpZirS', null, 'http://localhost:9090/api/v1/images/users/f9c89556-cd27-481a-a8bd-59f4915f7dfa'),
    (118, 'd33ded75-c9f3-4fef-9762-0ba4a905efa8', 'Antonio', 'Monje Aranibar', '201604527@est.umss.edu', '62933721', '$2a$10$WkEApzE76Il8U/ABhuKUY.kt.hg4AHzaibGxeLV15T4ih/HOtQMsy', null, 'http://localhost:9090/api/v1/images/users/b3a64fc9-3d28-4b92-b296-2324f9c4e061'),
    (119, 'e54bd4dc-d8f6-42e9-8e94-5d56bf42416f', 'Jeyson', 'Valdivia Bernal', 'jeyson.valdivia@gmail.com', '76834814', '$2a$10$B4h21pH5vy5m7hQQlVbYKeStOWKVXyagdB6UyqaesPRNNDlQKfBui', null, 'http://localhost:9090/api/v1/images/users/e326bdb8-6eee-4814-a877-9e063183f410'),
    (120, 'ae542968-1335-425e-a206-283c38a20190', 'Omar', 'Argenes Quispe', 'argenes77@gmail.com', '65692585', '$2a$10$/EIiJ48MBmun4XJma4NjqOpzO2HAyr.4gR8T760PhL56rLxjsjlju', null, 'http://localhost:9090/api/v1/images/users/004fca51-d313-41c4-94ff-5908ddb58dc2'),
    (121, '7f9264d7-ca8d-41ca-be1f-d24c9dd244a2', 'Bianca', 'Antelo Dominguez', 'bianca.dominguez@gmail.com', '73597236', '$2a$10$T3M7GX1wTTCB.ntkhqLNee6GBJSymV7qN0IiTCXU.zgXguw0SEd5e', null, 'http://localhost:9090/api/v1/images/users/2148f392-4f16-40b6-88e7-bd0ca32bd84a');
...
values(100, '17ucf8a1-09e0-4435-a850-0613d778897b', '1e5294f8-9a6c-4d9e-aea7-da7e80bd5c6f', 1, 'image', 'http://localhost:9090/api/v1/images/posts/3fddcbec-4bbe-411d-949a-4e4ab9fa986a'),
    ...
    (109, '8xm4v1n3-09e0-4435-a850-0613d778897b', '4g9dn2m6-9a6c-4d9e-aea7-da7e80bd5c6f', 1, 'image', 'http://localhost:9090/api/v1/images/posts/e30629ef-d0e2-47f2-8fbb-cb3344e4f319'),
    (110, '3v7c2gs8-09e0-4435-a850-0613d778897b', '9vm3n7a3-9a6c-4d9e-aea7-da7e80bd5c6f', 1, 'image', 'http://localhost:9090/api/v1/images/posts/b96f6ec8-655f-45de-943b-107300a8e25a'),
    ...
    (112, 'j4v9e6l1-09e0-4435-a850-0613d778897b', 'g7k3v8d5-9a6c-4d9e-aea7-da7e80bd5c6f', 1, 'image', 'http://localhost:9090/api/v1/images/posts/b65f8646-ebf4-4bec-9403-df64908ac870'),
    (113, 'h6m2s9c7-09e0-4435-a850-0613d778897b', 'k3n6m1a9-9a6c-4d9e-aea7-da7e80bd5c6f', 1, 'image', 'http://localhost:9090/api/v1/images/posts/18e154d3-c772-4dd0-ac24-847cefc0679a');
...
insert into image_file (id, uuid, url_resource, status, type)
    values (100, '3fddcbec-4bbe-411d-949a-4e4ab9fa986a', 'http://localhost:9090/api/v1/images/posts/3fddcbec-4bbe-411d-949a-4e4ab9fa986a', 'SAVED_SUCCESSFULLY','image/jpeg'),
     ...
     (109, 'e30629ef-d0e2-47f2-8fbb-cb3344e4f319', 'http://localhost:9090/api/v1/images/posts/e30629ef-d0e2-47f2-8fbb-cb3344e4f319', 'SAVED_SUCCESSFULLY','image/jpeg'),
     (110, 'b96f6ec8-655f-45de-943b-107300a8e25a', 'http://localhost:9090/api/v1/images/posts/b96f6ec8-655f-45de-943b-107300a8e25a', 'SAVED_SUCCESSFULLY','image/jpeg'),
     ...
     (116, 'b65f8646-ebf4-4bec-9403-df64908ac870', 'http://localhost:9090/api/v1/images/posts/b65f8646-ebf4-4bec-9403-df64908ac870', 'SAVED_SUCCESSFULLY','image/jpeg'),
     (117, 'e867fa32-75b7-4c3c-8943-4a2808c10ac0', 'http://localhost:9090/api/v1/images/users/e867fa32-75b7-4c3c-8943-4a2808c10ac0', 'SAVED_SUCCESSFULLY','image/png'),
     (118, '733b01ba-198e-42db-b9ca-d7ace9a7abad', 'http://localhost:9090/api/v1/images/users/733b01ba-198e-42db-b9ca-d7ace9a7abad', 'SAVED_SUCCESSFULLY','image/png'),
     (119, '06b8fbe5-9d91-422b-bd20-6d89d23e5608', 'http://localhost:9090/api/v1/images/users/06b8fbe5-9d91-422b-bd20-6d89d23e5608', 'SAVED_SUCCESSFULLY','image/png'),
     (120, 'b5de2b13-4720-41e7-87d2-d31abd590fac', 'http://localhost:9090/api/v1/images/users/b5de2b13-4720-41e7-87d2-d31abd590fac', 'SAVED_SUCCESSFULLY','image/png'),
     (121, '5e9f9c0d-4c31-4335-a11e-b9c7f6f8a2b1', 'http://localhost:9090/api/v1/images/users/5e9f9c0d-4c31-4335-a11e-b9c7f6f8a2b1', 'SAVED_SUCCESSFULLY','image/png'),
     (122, '1bed8052-ba51-41c2-88b5-e39e78dbf420', 'http://localhost:9090/api/v1/images/users/1bed8052-ba51-41c2-88b5-e39e78dbf420', 'SAVED_SUCCESSFULLY','image/png'),
     (123, '28e3d103-76e8-4b0d-b04c-cf2e8821cf6e', 'http://localhost:9090/api/v1/images/users/28e3d103-76e8-4b0d-b04c-cf2e8821cf6e', 'SAVED_SUCCESSFULLY','image/png'),
     (124, 'f9c89556-cd27-481a-a8bd-59f4915f7dfa', 'http://localhost:9090/api/v1/images/users/f9c89556-cd27-481a-a8bd-59f4915f7dfa', 'SAVED_SUCCESSFULLY','image/png'),
     (125, 'b3a64fc9-3d28-4b92-b296-2324f9c4e061', 'http://localhost:9090/api/v1/images/users/b3a64fc9-3d28-4b92-b296-2324f9c4e061', 'SAVED_SUCCESSFULLY','image/png'),
     (126, 'e326bdb8-6eee-4814-a877-9e063183f410', 'http://localhost:9090/api/v1/images/users/e326bdb8-6eee-4814-a877-9e063183f410', 'SAVED_SUCCESSFULLY','image/png'),
     (127, '004fca51-d313-41c4-94ff-5908ddb58dc2', 'http://localhost:9090/api/v1/images/users/004fca51-d313-41c4-94ff-5908ddb58dc2', 'SAVED_SUCCESSFULLY','image/png'),
     (128, '2148f392-4f16-40b6-88e7-bd0ca32bd84a', 'http://localhost:9090/api/v1/images/users/2148f392-4f16-40b6-88e7-bd0ca32bd84a', 'SAVED_SUCCESSFULLY','image/png'),
     (129, '18e154d3-c772-4dd0-ac24-847cefc0679a', 'http://localhost:9090/api/v1/images/posts/18e154d3-c772-4dd0-ac24-847cefc0679a', 'SAVED_SUCCESSFULLY', 'image/jpeg'),
     (130, '526e6a41-f1cd-42e1-ab6c-e32ccbfdddb6', 'http://localhost:9090/api/v1/videos/posts/526e6a41-f1cd-42e1-ab6c-e32ccbfdddb6', 'SAVED_SUCCESSFULLY', 'video/mp4');
